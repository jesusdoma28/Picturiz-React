...
import { changeMeGusta } from '../../Service/Services'
...
function MgButton(props) {
  ...
  function darQuitarMeGusta() {
    console.log('mgButton publi_id: ' + publi_id);
    console.log('mgButton meGusta: ' + meGusta);
    if (meGusta == true) {
      changeMeGusta(meGusta, publi_id);
      meGusta = false;
      this.forceUpdate()
  ...
  <div class="bg-gray-100 p-4 grid place-items-center">
    <div class="bg-white border rounded-sm max-w-md">
      <div class="flex items-center px-4 py-3">
        <img class="h-8 w-8 rounded-full" src="{img}" />
        <div class="ml-3 ">
